...
`terra-legal` is the donor layer for:
...
### 5. Documentation and repository standards
...
When original documentary surfaces live outside `terra-legal`, this repository should do one of three things:

1. carry the literal donor text when exact wording is normative;
2. carry an extracted bridge text when the original is too implementation-specific;
3. point clearly to the donor source and explain the dependency.

## Coherence rule

This repository is coherent only if:
