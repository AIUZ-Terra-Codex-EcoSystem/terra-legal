...
- every used standard license has a canonical text in `LICENSES/` where required;
...
This rule is aligned with the stabilized file-scoped licensing architecture prepared under TraceLog `TL-2026-06-14-003`.
