...
# (human-readable English alias; original preserved under original_основа живых протоколов Терра.md)
...
- Article 4: Non-Versioning
  - Terra is living. The notion of "version numbers" is only a human annotation for archival snapshots; the living trace system avoids version-lock while allowing archival snapshots and human-readable aliases.
